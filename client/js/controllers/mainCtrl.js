...
// main controller
trakkerApp.controller('mainCtrl', function ($scope, $q, usersService, projectsService, timeTableService) {
    ...
    $scope.$watch('user', function () {
        if ($scope.user) {
            ...
            // tableBaseDay to today, this will trigger proper updates of table dates
